...
mypublisher_client1=MQTTclient("publisherclient1",port,40,"localhost",clear_session=0)
...
if not mypublisher_client2.connect():
	print ("Error while connecting")
	sys.exit(0)
mypublisher_client3=MQTTclient("publisherclient3",port,40,"localhost",clear_session=0)
if not mypublisher_client3.connect():
	print ("Error while connecting")
	sys.exit(0)
mypublisher_client4=MQTTclient("publisherclient4",port,40,"localhost",clear_session=0)
if not mypublisher_client4.connect():
	print ("Error while connecting")
	sys.exit(0)
mypublisher_client5=MQTTclient("publisherclient5",port,40,"localhost",clear_session=0)
